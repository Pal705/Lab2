...
enum classeConfortSouhaitee {TOURISTIQUE,AFFAIRE,LOCAL,PROMO,LUXE};
...
public Client( int p_montantInitial, double p_distanceSouhaitee, String p_nom, classeConfortSouhaitee p_ClasseConfort){
...
public String toString(){
	return nom + "possede" + getArgent() + "a parcouru" + getDistanceParcourue() ;
}
